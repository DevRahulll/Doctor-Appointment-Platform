          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground text-lg md:text-xl max-w-md">
                Book appointments, consult via video manage your healthcare journey all in one secure platform.
              </p>
                  ...
                  {creditBenefits.map((benefit, index) => {
                    return (
                      <li key={index} className="flex items-start">
                        <div className="mr-3 mt-1 bg-emerald-900/20 p-1 rouned-fu">
        ...
        <div className="container mx-auto px-4">
          <Card className="bg-linear-to-r from-emerald-900/30 to-emerald-950/20 border-emerald-800/20">
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              ...
              <div className="absolute right-0 top-0 w-75 h-75 bg-emerald-800/10 rounded-full blur-3xl -mr-20 -mt-20 "></div>
              <div className="absolute left-0 bottom-0 w-50 h-50 bg-emerald-700/10 rounded-full blur-3xl -ml-10 -mb-10 "></div>
            </CardContent>
          </Card>
        </div>
      </section>
